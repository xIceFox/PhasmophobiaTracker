...
if(task1>0)task1Element.appendChild(document.createTextNode(OBJECTIVES[task1]));
if(task2>0)task2Element.appendChild(document.createTextNode(OBJECTIVES[task2]));
if(task3>0)task3Element.appendChild(document.createTextNode(OBJECTIVES[task3]));
